...
| cloud.backoff.factor | string | `"1.6"` | Factor multiplied by Duration for each iteration |
| cloud.backoff.steps | string | `"5"` | Remaining number of iterations in which the duration parameter may change |
...
| driver.enableSnapshotCrossNamespace | bool | `false` | Enable snapshot cross namespace True if enable snapshot cross namespace |
...
| driver.imagePullPolicy | string | `"IfNotPresent"` | Container pull policy |
...
| sidecars.attacher.metricsPort | string | `"8090"` | Port of the http endpoint |
...
| sidecars.kubeAPI | object | `{"QPS":20,"burst":100}` | kube api throttling |
...
| sidecars.provisioner.metricsPort | string | `"8089"` | Port of the http endpoint |
...
| sidecars.resizer.metricsPort | string | `"8092"` | Port of the http endpoint |
...
| sidecars.snapshotter.metricsPort | string | `"8091"` | Port of the http endpoint |
