...
func (m *MockCloud) CheckCreatedVolume(ctx context.Context, name string, capacityBytes int64) (*cloud.Volume, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "CheckCreatedVolume", ctx, name, capacityBytes)
...
func (mr *MockCloudMockRecorder) CheckCreatedVolume(ctx, name, capacityBytes any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "CheckCreatedVolume", reflect.TypeOf((*MockCloud)(nil).CheckCreatedVolume), ctx, name, capacityBytes)
}
...
func (m *MockCloud) UpdateVolume(ctx context.Context, volumeID, volumeType string, iopsPerGB int) error {
	m.ctrl.T.Helper()
