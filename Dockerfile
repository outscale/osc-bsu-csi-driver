...
RUN echo "deb http://deb.debian.org/debian testing non-free contrib main" >> /etc/apt/sources.list &&\
    ...
    apt-get -y update
# TO FIX CVE
RUN DEBIAN_FRONTEND=noninteractive && clean-install libc-bin=2.31-9 libgnutls30=3.7.0-5 libidn2-0=2.3.0-4 libudev1=247.2-4 udev=247.2-4 libsqlite3-0=3.34.0-1
